...
exports.formatSuccess = exports.formatError = void 0;
...
var formatSuccess = function formatSuccess(text) {
  return "\n    <span style=\"color: green;\">\n        ".concat(text, "\n    </span>\n");
};

exports.formatSuccess = formatSuccess;
},{}],"src/switch_tabs.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tabSwitcher = void 0;

var tabSwitcher = function tabSwitcher(target, allTargets) {
...
var _switch_tabs = require("./switch_tabs.js");
...
var timerStopText = document.getElementById("timer__stop");
var howManySecs = document.getElementById("howManySecs");
var cur = 1;

var runTimer = function runTimer(last) {
  /*** 1000 sec max */
  if (cur < 1000 && last > 0) {
    if (cur <= last) {
      if (cur !== last) tick.play();

      if (cur === last) {
        timerStopText.innerHTML = (0, _utils.formatSuccess)("\u0422\u0430\u0439\u043C\u0435\u0440 \u0437\u0430\u043A\u043E\u043D\u0447\u0438\u043B\u0441\u044F ".concat(last));
        clearInterval(window.S);
        sound.play();
      }

      document.getElementById("timer__result").innerHTML = "".concat(cur++, ":00");
    }
  } else {
    clearInterval(window.S);
    timerStopText.innerHTML = (0, _utils.formatError)("Максимальное время таймера закончилось или не установлено окончание");
  }
...
var tabsSpan = document.querySelectorAll('.tabs > div > span');
var tab = document.querySelectorAll('.tab');
tabsSpan.forEach(function (element, idx) {
  element.addEventListener("click", function (ev) {
    (0, _switch_tabs.tabSwitcher)(ev.target, tabsSpan);
    (0, _switch_tabs.tabSwitcher)(document.querySelectorAll('.tab')[idx], tab);
  });
});
},{"./datecalc.js":"src/datecalc.js","./utils.js":"src/utils.js","./switch_tabs.js":"src/switch_tabs.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
